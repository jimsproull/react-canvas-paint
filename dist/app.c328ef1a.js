...
exports.MODES = MODES;
},{}],"src/components/CanvasPaintKeyboard.jsx":[function(require,module,exports) {
"use strict";
...
var CanvasPaintKeyboard = function CanvasPaintKeyboard(_ref) {
  ...
  var keys = {
    c: function c(state) {
      return _objectSpread({}, state, {
        mode: _constants.MODES.CLEAR
      });
    },
    e: function e(state) {
      return _objectSpread({}, state, {
        brushType: _constants.BRUSHES.ERASER
      });
    },
    b: function b(state) {
      return _objectSpread({}, state, {
    ...
    p: function p(state) {
      return _objectSpread({}, state, {
        brushType: _constants.BRUSHES.PENCIL
      });
    }
  };
  var metaKeys = {
    z: function z(state, metaKey, shiftKey) {
      if (metaKey && shiftKey) {
        return _objectSpread({}, state, {
          mode: _constants.MODES.REDO
        });
      } else {
        return _objectSpread({}, state, {
          mode: _constants.MODES.UNDO
        });
      }
    }
  };
  ...
  function handleKeyEvent() {
    if (keyEvent) {
      ...
      if ((containsMeta || containsShift) && metaKeys[keyEvent.key]) {
        newState = metaKeys[keyEvent.key](newState, containsMeta, containsShift);
  ...
  function onModeSwitch(mode, previousMode) {
    if (mode != previousMode && (mode == _constants.MODES.UNDO || mode == _constants.MODES.REDO)) {
  ...
  return _react.default.cloneElement(children, _objectSpread({}, canvasState, {
...
},{"react":"node_modules/react/index.js","../constants":"src/constants.js"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"src/components/CanvasPaint.css":[function(require,module,exports) {
...
var CanvasPaint = _react.default.forwardRef(function (_ref, ref) {
  var brushType = _ref.brushType,
      ...
      mode = _ref.mode,
      onStartDraw = _ref.onStartDraw,
      onEndDraw = _ref.onEndDraw,
      pixelData = _ref.pixelData;
  ...
  var canvasRef = ref || (0, _react.useRef)(null);
  (0, _react.useEffect)(function () {
  ...
  (0, _react.useLayoutEffect)(function () {
    if (pixelData) {
      (0, _canvas.drawImageData)(canvasRef.current, pixelData);
    }
  }, [pixelData]);
...
CanvasPaint.propTypes = {
  ...
  onStartDraw: _propTypes.default.func,
  onEndDraw: _propTypes.default.func
};
CanvasPaint.defaultProps = {
  ...
  width: '400px',
  height: '400px',
  onStartDraw: function onStartDraw() {},
  onEndDraw: function onEndDraw() {}
};
...
exports.default = _default;
},{"react":"node_modules/react/index.js","./CanvasPaint.css":"src/components/CanvasPaint.css","prop-types":"node_modules/prop-types/index.js","../draw":"src/draw.js","../canvas":"src/canvas.js","../constants":"src/constants.js"}],"src/components/CanvasPaintUndoable.jsx":[function(require,module,exports) {
"use strict";
...
var _CanvasPaint = _interopRequireDefault(require("./CanvasPaint"));
...
var CanvasPaintUndoable = function CanvasPaintUndoable(_ref) {
  var mode = _ref.mode,
      props = _objectWithoutProperties(_ref, ["mode"]);

  var _useState = (0, _react.useState)([]),
      _useState2 = _slicedToArray(_useState, 2),
      undoStack = _useState2[0],
      setUndoStack = _useState2[1];

  var _useState3 = (0, _react.useState)(-1),
      _useState4 = _slicedToArray(_useState3, 2),
      undoIndex = _useState4[0],
      setUndoIndex = _useState4[1];
  ...
  var _useState7 = (0, _react.useState)(),
      _useState8 = _slicedToArray(_useState7, 2),
      pixelData = _useState8[0],
      setPixelData = _useState8[1];

  var canvasRef = (0, _react.useRef)(); // todo make this a hook?
  ...
  (0, _react.useEffect)(function () {
    if (mode != lastMode && canvasRef.current) {
      switch (mode) {
        case _constants.MODES.CLEAR:
          {
            addToUndoStack((0, _canvas.getImageData)(canvasRef.current));
            break;
          }

        case _constants.MODES.UNDO:
          {
            var newUndoIndex = undoIndex - 1;
        ...
        case _constants.MODES.REDO:
          {
            var _newUndoIndex = undoIndex + 1;

            if (_newUndoIndex < undoStack.length) {
              setPixelData(undoStack[_newUndoIndex]);
              setUndoIndex(_newUndoIndex);
            }
  ...
  function onModeSwitch(mode, previousMode) {
    ...
    if (mode == _constants.MODES.UNDO || mode == _constants.MODES.REDO) {
      setPixelData(undefined);
    }
  }

  return _react.default.createElement(_CanvasPaint.default, _extends({}, props, {
...
CanvasPaintUndoable.propTypes = _CanvasPaint.default.propTypes;
CanvasPaintUndoable.defaultProps = _CanvasPaint.default.defaultProps;
var _default = CanvasPaintUndoable;
exports.default = _default;
},{"react":"node_modules/react/index.js","./CanvasPaint":"src/components/CanvasPaint.jsx","../constants":"src/constants.js","../canvas":"src/canvas.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var _CanvasPaintUndoable = _interopRequireDefault(require("./src/components/CanvasPaintUndoable.jsx"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.renderCanvasPaint = function (node) {
  _reactDom.default.render(_react.default.createElement(_CanvasPaintKeyboard.default, null, _react.default.createElement(_CanvasPaintUndoable.default, null)), node);
};
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./src/components/CanvasPaintKeyboard.jsx":"src/components/CanvasPaintKeyboard.jsx","./src/components/CanvasPaintUndoable.jsx":"src/components/CanvasPaintUndoable.jsx"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
